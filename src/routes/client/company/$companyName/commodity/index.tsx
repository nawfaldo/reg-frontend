...
function RouteComponent() {
  ...
  const isLoading = isLoadingCompany || isLoadingCommodities;
    ...
    return (
      <div className="px-6 pt-6 h-full bg-white">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <p className="text-red-800">Anda tidak memiliki izin untuk melihat daftar komoditas</p>
        </div>
      </div>
    );
  }
    ...
    <div className="px-6 pt-1 h-full bg-white">
      <div className="flex items-center space-x-10 mb-4">
        ...
        <div className='ml-auto'>
          ...
          ) : hasPermission('commodity:create') ? (
                ...
                <tr key={commodity.id} className="border-b border-gray-200">
                  ...
                  <td className="py-3 pl-1 pr-2">
                    <div className="flex items-center gap-2">
                      ...
                      {hasPermission('commodity:update') && (
                        <Link
